							...
							const float* pos, const float radius, const float height, const unsigned char areaId)
{
	...
	int minx = (int)Math::floorf((bmin[0]-orig[0])*ics);
	int miny = (int)Math::floorf((bmin[1]-orig[1])*ich);
	int minz = (int)Math::floorf((bmin[2]-orig[2])*ics);
	int maxx = (int)Math::floorf((bmax[0]-orig[0])*ics);
	int maxy = (int)Math::floorf((bmax[1]-orig[1])*ich);
	int maxz = (int)Math::floorf((bmax[2]-orig[2])*ics);
