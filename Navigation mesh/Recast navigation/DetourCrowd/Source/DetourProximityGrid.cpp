...
{
	const int iminx = (int)Math::floorf(minx * m_invCellSize);
	const int iminy = (int)Math::floorf(miny * m_invCellSize);
	const int imaxx = (int)Math::floorf(maxx * m_invCellSize);
	const int imaxy = (int)Math::floorf(maxy * m_invCellSize);
