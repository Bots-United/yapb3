...
Sample_SoloMesh::Sample_SoloMesh() :
	...
	m_pmesh(0),
	m_dmesh(0),
	m_drawMode(DRAWMODE_NAVMESH_TRANS/*DRAWMODE_NAVMESH - ORIGINAL*/)
{
...
bool Sample_SoloMesh::handleBuild()
{
	...
	rcMarkWalkableTriangles(m_ctx, m_cfg.walkableSlopeAngle/*!, verts, nverts, tris*/, ntris, m_geom->getMesh()->getNormals(), m_triareas);
	rcRasterizeTriangles(m_ctx, verts, nverts, tris, m_triareas, ntris, *m_solid, m_cfg.walkableClimb);

	{
	const Math::Vector3D center (Math::Vector3D (m_cfg.bmin).GetMidPoint (Math::Vector3D (m_cfg.bmax)));

	HalfLifeEngine::Globals::g_halfLifeEngine->ServerPrintFormat ("Sample_SoloMesh::handleBuild():\n\tnverts=%i,\n\tntris=%i,\n\twidth=%i,\n\theight=%i,\n\tbmin: [%.2f, %.2f, %.2f],\n\tbmax: [%.2f, %.2f, %.2f],\n\t\tcenter: [%.2f, %.2f, %.2f].\n", nverts, ntris, m_cfg.width, m_cfg.height, m_cfg.bmin[0], m_cfg.bmin[2], m_cfg.bmin[1], m_cfg.bmax[0], m_cfg.bmax[2], m_cfg.bmax[1], center.x, center.z, center.y);
	}
