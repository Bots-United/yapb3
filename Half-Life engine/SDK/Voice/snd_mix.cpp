...
extern "C"
{
	...
	extern void SND_PaintChannelFrom8(int *volume, unsigned char *pData8, int endtime);
	extern void SND_PaintChannelFrom8toDry(int *volume, unsigned char *pData8, int count);
...
#if	!id386
void SND_PaintChannelFrom8( int *volume, unsigned char *pData8, int count )
{
	int 	data;
	int		*lscale, *rscale;
	int		i;
...
void SW_Mix8StereoDopplerLeft( portable_samplepair_t *pOutput, int *volume, unsigned char *pData, int inputOffset, fixedint rateScaleFix, int outCount ) 
{
	int sampleIndex = 0;
...
void SW_Mix8StereoDopplerRight( portable_samplepair_t *pOutput, int *volume, unsigned char *pData, int inputOffset, fixedint rateScaleFix, int outCount ) 
{
	int sampleIndex = 0;
	fixedint sampleFrac = inputOffset;
	int		*lscale, *rscale;
...
void SW_Mix8StereoDirectional( float soundfacing, portable_samplepair_t *pOutput, int *volume, unsigned char *pData, int inputOffset, fixedint rateScaleFix, int outCount ) 
{
	int sampleIndex = 0;
	fixedint sampleFrac = inputOffset;
	int	x;
...
void SW_Mix8StereoDistVar( float distmix, portable_samplepair_t *pOutput, int *volume, unsigned char *pData, int inputOffset, fixedint rateScaleFix, int outCount ) 
{
	int sampleIndex = 0;
	fixedint sampleFrac = inputOffset;
	int	x;
...
void SW_Mix8Mono( portable_samplepair_t *pOutput, int *volume, unsigned char *pData, int inputOffset, fixedint rateScaleFix, int outCount )
{
	...
	if ( rateScaleFix == FIX(1) )
	{
		...
		{
			SND_PaintChannelFrom8( volume, (unsigned char *)pData, outCount );
			return;
		}
...
void SW_Mix8Stereo( portable_samplepair_t *pOutput, int *volume, unsigned char *pData, int inputOffset, fixedint rateScaleFix, int outCount )
{
	int sampleIndex = 0;
	fixedint sampleFrac = inputOffset;
	int		*lscale, *rscale;
...
void Mix8MonoWavtype( channel_t *pChannel, portable_samplepair_t *pOutput, int *volume, unsigned char *pData, int inputOffset, fixedint rateScaleFix, int outCount )
{
...
void Mix8StereoWavtype( channel_t *pChannel, portable_samplepair_t *pOutput, int *volume, unsigned char *pData, int inputOffset, fixedint rateScaleFix, int outCount )
{
...
void SND_MoveMouth8( channel_t *ch, CAudioSource *pSource, int count ) 
{
	...
	while ( i < count && scount < CAVGSAMPLES )
	{
		...
		i += 80 + ((unsigned char)data & 0x1F);
		scount++;
	}

	pMouth->sndavg += savg;
	pMouth->sndcount = (unsigned char) scount;
