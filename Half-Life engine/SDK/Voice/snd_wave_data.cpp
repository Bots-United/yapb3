...
#pragma warning (disable: 4512)	// warning C4512: 'HalfLifeEngine::SDK::Voice::CWaveDataMemory' : assignment operator could not be generated
...
private:
	...
	//
	private:
		inline CWaveDataMemory &operator = (const CWaveDataMemory &/*right*/);	// Avoid "warning C4512: 'CWaveDataMemory' : assignment operator could not be generated".
};
...
private:
	...
	//
	private:
		inline CWaveDataStream &operator = (const CWaveDataStream &/*right*/);	// Avoid "warning C4512: 'CWaveDataStream' : assignment operator could not be generated".
};
